...
Run:  python cases/inn-KB15-2025-hydro/hotstart_probe.py [--analyse]
"""
...
from axqua import read_roughness_zones, run_solver_streaming
...
def build(cfg, probe_dir: Path) -> dict[str, Path]:
    ...
    from axqua.bayescal import FlowSpec, write_flow_cas

    from axqua.core.selafin import extract_hotstart
...
def analyse(cfg, probe_dir: Path) -> int:
    ...
    pts = pd.concat([pd.read_csv(cfg.preprocessing_dir
