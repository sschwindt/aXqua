...
def test_read_roughness_zones_bounds_schema(tmp_path):
    ...
    from axqua.core.geodata import read_roughness_table, read_roughness_zones
...
def test_calibration_parameters_from_roughness_table(tmp_path):
    ...
    from axqua.config import CalibrationParameter, load_config
...
def test_bounds_without_calibration_column_calibrates_all(tmp_path):
    ...
    from axqua.calibration import roughness_zone_parameters
    from axqua.config import load_config
